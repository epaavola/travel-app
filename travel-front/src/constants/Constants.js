const prod = {
    url: {
      ...
      KEYCLOAK_BASE_URL: 'https://hallinta.missio.paavolagroup.fi/auth',
  ...
  const dev = {
    url: {
      ...
      MISSIONS_API_URL: 'http://localhost:7000/api/v1/missions/',
      FILE_API_URL: 'http://localhost:7000/api/v1/files/'
    },
    keycloak: {
      REALM: "Travel-app",
      CLIENT: "travel-service"
